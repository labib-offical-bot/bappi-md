...
global.BOT_NAME = "☠︎︎ 𝐁ᴀᴩᴩɪ xᴍᴅ ☠︎︎︎"
global.bankowner = "☠︎︎ 𓆩𝐋𝐚𝐛𝐢𝐛 𝐨𝐟𝐟𝐢𝐜𝐚𝐥𓆪 ☠︎︎"
global.creatorName = "☠︎︎ 𓆩𝐋𝐚𝐛𝐢𝐛 𝑶𝒇𝒇𝒊𝒄𝒊𝒂𝒍𓆪 ☠︎︎"
global.ownernumber = '8801877316871'  //creator number
...
global.author = "𝐋𝐚𝐛𝐢𝐛 𝐨𝐟𝐟𝐢𝐜𝐚𝐥"
global.creator = "8801877316871@s.whatsapp.net"
global.ownername = '☠︎︎ 𝐋𝐚𝐛𝐢𝐛𝑶𝒇𝒇𝒊𝒄𝒊𝒂𝒍 ☠︎︎' 
global.onlyowner = `☠️ 𝙎𝙤𝙧𝙧𝙮, 𝙏𝙝𝙞𝙨 𝙁𝙚𝙖𝙩𝙪𝙧𝙚 𝙄𝙨 𝙍𝙚𝙨𝙩𝙧𝙞𝙘𝙩𝙚𝙙 𝙏𝙤 𝙊𝙬𝙣𝙚𝙧𝙨 𝙊𝙣𝙡𝙮.  
🩸 𝘾𝙤𝙣𝙩𝙖𝙘𝙩 *Labib* 𝙩𝙤 𝙜𝙖𝙞𝙣 𝙤𝙬𝙣𝙚𝙧 𝙥𝙧𝙞𝙫𝙞𝙡𝙚𝙜𝙚𝙨.  
🕳️ 𝙄𝙡𝙡𝙚𝙜𝙖𝙡 𝙖𝙘𝙘𝙚𝙨𝙨 𝙬𝙞𝙡𝙡 𝙗𝙚 𝙘𝙡𝙚𝙖𝙣𝙨𝙚𝙙 𝙗𝙮 𝙩𝙝𝙚 𝑻𝒂𝒍𝒉𝒂.`
  // reply 
global.database = `☠️ 𝙏𝙤 𝙗𝙚 𝙖𝙙𝙙𝙚𝙙 𝙩𝙤 𝙩𝙝𝙚 𝘿𝘼𝙏𝘼𝘽𝘼𝙎𝙀 𝘽𝘼𝙎𝙀...  
🩸 𝘾𝙤𝙣𝙩𝙖𝙘𝙩 *Labib* — 𝙊𝙧 𝙗𝙚 𝙚𝙧𝙖𝙨𝙚𝙙 𝙗𝙮 𝙙𝙚𝙛𝙖𝙪𝙡𝙩.  🔗 *No entry without approval.*`
  global.mess = {
wait: "```☠️ WAIT FOR  ☠︎︎ 𝐁ᴀᴩᴩɪ xᴍᴅ ☠︎︎😈 ⚡ *Darkness intensifies...*  💀 *Brace yourself — The Labib is rising.*```",
   success: "✔️ 𝗦𝗨𝗖𝗖𝗘𝗦𝗦 𝗕𝗬 ☠︎︎ 𝐁ᴀᴩᴩɪ xᴍᴅ  ☠︎︎ ⚔️`  🔥 *Mission complete. The Void accepts your command.*",
   on: "`✔️☠︎︎ 𝐁ᴀᴩᴩɪ xᴍᴅ  ☠︎︎𝗔𝗖𝗧𝗜𝗩𝗘 ⚔️`  🔥 *The Labib is unleashed. Power running at full force.*  🕳️ *Enter if you dare.*", 
   ...
   off: "`❌ ☠︎︎ 𝐁ᴀᴩᴩɪ xᴍᴅ  ☠︎︎𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗢𝗙𝗙 ⚰️`  🕳️ *The labib has gone dark. All systems offline.*  ⚡ *Recharge and prepare for the next awakening.*",
   query: {
...
private: "Sorry bro, This Feature Can Only Be Used In Private Chats",
       owner: "Sorry bro, This Feature Can Only Be Used by ☠︎︎ 𝑺𝒉𝒂𝒅𝒐𝒘 𝑶𝒇𝒇𝒊𝒄𝒊𝒂𝒍 ☠︎︎brr😋",
       ...
       premium: "This feature is specifically for my owner ༒︎ 𝑺𝑯𝑨𝑫𝑶𝑾 ༒︎🤤🫡",
   }
}

global.onlyowner = `\`[ 🤞 ] ☠︎︎ 𝐁ᴀᴩᴩɪ xᴍᴅ  ☠︎︎ \` \n*
...
global.database = `\`[ 👑 ] ☠︎︎ 𝐁ᴀᴩᴩɪ xᴍᴅ  ☠︎︎ 😙 \` \n*
